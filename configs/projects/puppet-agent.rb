project "puppet-agent" do |proj|
  ...
  if platform.is_macos?
    ...
    proj.signing_command '"security -q unlock-keychain -p \$$OSX_SIGNING_KEYCHAIN_PW \$$OSX_SIGNING_KEYCHAIN; codesign --timestamp --options=runtime --keychain \$$OSX_SIGNING_KEYCHAIN -vfs \"\$$OSX_CODESIGNING_CERT\""'
  end
